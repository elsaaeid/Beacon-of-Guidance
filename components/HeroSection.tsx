    ...
    <section className={styles.heroSection}>
      <div className={styles.textContainer}>
        ...
        <p className={styles.subheading}>
          يقدم منارة الهداى تعليم القرآن الكريم والعلوم الشرعية على يد نخبة من المعلمين المعتمدين من الأزهر الشريف ووزارة الأوقاف المصرية. بأساليب تعليمية حديثة ومبتكر
        </p>
